          ...
          <div
            ...
            <div className="px-4 py-10 lg:py-32 md:px-28 max-w-[1600px]">
              ...
              <section className="hidden lg:max-w-[1600px] w-full lg:flex justify-center items-center my-24">
                <div className="grid lg:flex w-full gap-4 justify-center items-center">
                  <div className="flex flex-col gap-4">
                    <div className="gap-1 lg:gap-0 w-full h-[160px] p-4 font-jost font-medium text-xl lg:text-4xl text-white flex items-end">
